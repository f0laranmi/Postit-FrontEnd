...
const token = localStorage.getItem('token')
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch ('https://postitfola-server.onrender.com/api/user/story', {
        method: 'POST',
        body: formData,
        headers: {
          ...
          <div className="task3">
            ...
            <form encType="multipart/form-data" onSubmit={handleSubmit}>
              <div className="titleTask">
                ...
                <input required type="file" accept="image/*" id="taskTitle" placeholder="select image" onChange={(e) => setImage(e.target.files[0])} />
              </div>
